...
EPUBcfi.CFIInstructions = {
	...
	applyBlacklist : function ($elements, classBlacklist, elementBlacklist, idBlacklist) {
        ...
        //calculate blacklisted elements
        ...
        $blacklisted.each(function(index, value) {
            //get the list of the blacklisted elements children which are blacklisted
            ...
            //replace the blacklisted element with its non-blacklisted children
            if ($nonBlacklistedChildren.length > 0) {
                $filteredElements.splice(itemIndex, 1, $.makeArray($nonBlacklistedChildren));
            } else {
